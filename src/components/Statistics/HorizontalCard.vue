...
<template>
    <q-card class="col-4" style="min-width: 520px; max-width: 520px;">
        <q-item>
            <q-item-section>
        ...
        <q-card-section>
            ...
            <div class="col">
            <div class="row">
                <div class="q-pa-xs col q-gutter-sm">
                    <q-card class="q-pa-sm q-pl-sm q-gutter-xs item-card">
                        <div>План</div>
                        <div class="row">
                    ...
                    <q-card class="q-px-sm q-pt-md q-pb-md q-gutter-xs item-card"
                        style="cursor: pointer;">
                        <div style="font-size: 16px; font-weight: 600; text-align: center">
                            Осмотров
                        </div>
                        <div class="row q-pt-md q-pb-sm">
                            <div class="col q-mt-md" style="font-size: 20px; font-weight: 600; text-align: center">
                                <div>0</div>
                            </div>
                            <div class="col">
                    ...
                    <q-card class="q-pa-sm q-gutter-xs item-card">
                        <div>Допуски</div>
                        <div class="row">
                            <div class="col numbers">
                                <div>0</div>
...
<div class="col">
      <div class="row">
        <div class="q-px-sm q-py-sm col q-gutter-sm">
          <q-card  
            class="q-py-sm q-px-sm q-gutter-xs item-card" 
            style="height: 150px"
          >
        ...
        <div class="q-px-sm q-py-sm col q-gutter-md">
          <q-card class="q-pa-sm q-gutter-xs item-card">
            <div>Не на связи</div>
            <div class="row">
              <div class="col numbers">
