  ...
  <q-form greedy @submit="onSubmit">
    <div v-if="!hideOrganizationSelector">
      <div class="q-pa-md">
        <div class="q-gutter-md">
          ...
          <q-select v-model="organization" filled :rules="[val => val || 'Пожалуйста, выберите организацию']"
            label="Организация" :options="organizationOptions" option-value="id" option-label="name" style="width: 250px"
            use-input input-debounce="0" @update:model-value="OrganizationChangeValueHandler"
    ...
    <div class="q-pa-md">
      ...
      <div class="row justify-start">
        <q-input v-model="dates.from" outlined type="date" required />
        <q-input v-model="dates.to" outlined class="q-px-md" type="date" required />
      </div>
    </div>
    <div class="q-pa-md">
      <div class="q-gutter-sm">
        ...
        <q-option-group v-model="reportType" :options="reportTypeOptions" color="primary"
      ...
      <div class="q-gutter-sm">
        ...
        <div class="q-gutter-sm">
          <div class="row items-center">
            ...
            <div class="q-pa-sm">
              <q-option-group v-model="personnelRadio" :options="personnelRadioOptions" color="primary" inline
                @update:model-value="ChangePersonnelSelectorState()" />
            </div>
            <div class="q-pa-sm">
              <q-select v-model="personnelSelection" :disable="disablePersonnelSelector" filled use-chips
                behavior="dialog" multiple :rules="[val => val || 'Пожалуйста, выберите сотрудников']"
                :options="personnelSelectionOptions" option-value="id"
                :option-label="option => GetFullName(option.second_name, option.first_name, option.father_name)"
                label="Сотрудники" style="width: 250px" use-input input-debounce="0" @filter="personnelFilterFunc">
                <template #no-option>
                  <q-item>
                    <q-item-section class="text-grey">
        ...
        <div class="q-gutter-sm">
          <div class="row items-center">
            ...
            <div class="q-pa-sm">
              <q-option-group v-model="examTypeRadio" :options="examTypeRadioOptions" color="primary" inline
                @update:model-value="ChangeExamTypeSelectorState()" />
            </div>
            <div class="q-pa-sm">
              <q-select v-model="examTypeSelection" :disable="disableExamTypeSelector" filled
                :rules="[val => val || 'Пожалуйста, выберите тип осмотра']" :options="examTypeSelectionOptions"
                option-label="name" label="Тип осмотра" style="width: 250px">
                <template #no-option>
                  <q-item>
                    <q-item-section class="text-grey">
                      Не найдено
        ...
        <div class="q-gutter-sm">
          <div class="row items-center">
            ...
            <div class="q-pa-sm">
              <q-option-group v-model="admittanceRadio" :options="admittanceRadioOptions" color="primary" inline
    ...
    <div class="q-pa-md">
      <div class="q-gutter-sm">
        <q-btn color="dark" no-caps label="Сформировать" type="submit" :loading="loadingOnSubmitButton" />
      </div>
    </div>
  </q-form>
</template>
